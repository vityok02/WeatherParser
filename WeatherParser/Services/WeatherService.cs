...
public class WeatherService : IWeatherService
{
    ...
    private readonly IHtmlPathBuilder _htmlPathGenerator;

    public WeatherService(IWeatherParserService parser, IHtmlPathBuilder htmlPathGenerator)
    {
        _parser = parser;
        _htmlPathGenerator = htmlPathGenerator;
    }

    public Weather GetWeather(double latitude, double longitude)
    {
        var htmlPath = _htmlPathGenerator.GeneratePath(latitude, longitude);
        ...
        var currentTime = currentTimeNode.InnerText.ExtractTime();
